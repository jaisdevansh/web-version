...
export default function RegisterPage() {
  ...
  return (
    <div className="container relative min-h-[calc(100vh-8rem)] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      ...
      {/* Hero Left Side - Premium Carousel */}
        ...
        <div className="relative z-20 mb-10 p-8 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl">
          <blockquote className="space-y-4">
            <p className="text-xl leading-relaxed font-light text-white/90">
              &quot;Joining this platform was the best decision for our nightlife group.
              Our revenues are up 30% and guest management is flawless.&quot;
            </p>
            <footer className="text-sm font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400 uppercase tracking-widest">
              Alex Chen, Event Organizer
            </footer>
          </blockquote>
          ...
          <div className="flex gap-2 mt-6">
            {images.map((_, idx) => (
              <div 
                key={idx} 
                className={`h-1.5 rounded-full transition-all duration-500 ${idx === currentImageIndex ? 'w-8 bg-purple-500' : 'w-2 bg-white/20'}`} 
              />
            ))}
          </div>
        </div>
      ...
      <div className="p-4 py-24 lg:p-8 flex items-center justify-center min-h-[100dvh] lg:min-h-full bg-black/95">
        <div className="mx-auto flex w-full flex-col justify-center space-y-8 sm:w-[400px]">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input className="bg-white/5 border-white/10 text-white focus-visible:ring-purple-500 h-12 rounded-xl" placeholder="John Doe" {...field} disabled={isLoading} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input className="bg-white/5 border-white/10 text-white focus-visible:ring-purple-500 h-12 rounded-xl" placeholder="name@example.com" {...field} disabled={isLoading} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input className="bg-white/5 border-white/10 text-white focus-visible:ring-purple-500 h-12 rounded-xl" type="password" placeholder="••••••••" {...field} disabled={isLoading} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          <p className="px-8 text-center text-sm text-white/60">
            ...
            <Link
              href="/login"
              className="text-white font-medium underline underline-offset-4 hover:text-purple-400 transition-colors"
            >
              Sign in
            </Link>
          </p>
