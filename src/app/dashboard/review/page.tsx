      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8">
          <div className="bg-[#0b0c10] rounded-[2.5rem] border border-white/[0.03] overflow-hidden shadow-2xl h-full flex flex-col">
            <div className="p-8 lg:p-12 flex-1">
              ...
              <div className="mb-16 flex flex-col items-center bg-[#12161f]/50 p-10 rounded-3xl border border-white/[0.02]">
                ...
                <div className="flex justify-center space-x-4 mb-6">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star key={star} className="w-16 h-16 text-white/10 hover:text-yellow-400 hover:fill-yellow-400 transition-all cursor-pointer transform hover:scale-110" />
                  ))}
                </div>
                  ...
                  <div className="pb-8 border-b border-white/[0.03] flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-6">
                      {[1, 2, 3, 4, 5].map((circle) => (
                        <div key={circle} className="w-12 h-12 rounded-full border border-white/[0.15] cursor-pointer hover:bg-white/10 transition-all" />
                      ))}
                    </div>
                  </div>
            ...
            {/* Footer Button */}
            <div className="p-8 lg:p-10 pt-6 bg-[#0b0c10] mt-auto">
              <button 
