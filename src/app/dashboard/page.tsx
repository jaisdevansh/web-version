      ...
      {activeEvent && (
        <Card className="border-primary/50 bg-primary/5 shadow-lg shadow-primary/10">
          <CardContent className="p-6 flex flex-col md:flex-row items-center justify-between">
            ...
            <Link href={`/dashboard/events/live/${activeEvent._id}`}>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7 mt-8">
          ...
          <CardContent>
            <div className="space-y-6">
              {isLoadingBookings ? (
                ...
                <p className="text-muted-foreground text-sm">No upcoming bookings. <Link href="/dashboard/events" className="text-primary hover:underline">Discover events</Link></p>
              ) : (
        ...
        <Card className="col-span-3">
          ...
          <CardContent className="space-y-4">
            <Button className="w-full justify-between border-border" variant="outline" onClick={() => router.push('/dashboard/events')}>
